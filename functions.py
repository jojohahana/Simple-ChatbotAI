...
def create_bot(name):
    ...
    Bot = ChatBot(name = name, # Function takes name of teh bot as an input argument in case set it to Jordan
                  read_only = False,                  
...
def train_all_data(Bot): # Fork from https://github.com/gunthercox/chatterbot-corpus/find/master
